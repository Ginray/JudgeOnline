...
<nav class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.jsp">ZJGSU JudgeOnline</a>
    </div>
            ...
            <form action="user_userlogin.action" method="post" onsubmit="return login();">
                <div class="modal-body">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="userinfo.username" id="login_username" class="form-control"
                               placeholder="Username">
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon">Password:</span>
                        <input type="password" name="userinfo.password" id="login_password" class="form-control"
            ...
            <form action="user_userregister.action" method="post" onsubmit="return check();">
                <div class="modal-body">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="userinfo.username" id="register_username" class="form-control"
                               placeholder="Username">
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon">Password:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp*</span>
                        <input type="password" name="userinfo.password" id="password" class="form-control"
                               placeholder="Password">
                    </div>
                    <br>
                    <div class="input-group">
            ...
            <form action="user_usermodify.action" method="post" onsubmit="return checkmo();">
                <div class="modal-body">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="userinfo.username" class="form-control"
                               placeholder=<%=username %> disabled>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon">New Password:&nbsp&nbsp&nbsp&nbsp</span>
                        <input type="password" name="userinfo.password" id="mopassword" class="form-control"
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="userinfo.nickname" id="nickname" class="form-control"
