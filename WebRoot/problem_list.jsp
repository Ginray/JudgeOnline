...
<%@ page import="com.sun.xml.internal.ws.api.server.SDDocumentFilter" %>
<%
...
<div class="container">
                ...
                <div class="col-md-7 column">
                    ...
                    <div class="input-group">
                        <input name="search_keyword" id="search_keyword" type="text"
                               placeholder="please input the problem id | title keyword |source keyword "
    ...
    <table id="idData" class="table table-striped">
        ...
        <tr>
            ...
            <td><a href="problem_showProblem.action?problemId=<%=p.getProblemId() %>"><%=p.getTitle() %>
            </a></td>
            <td><%=p.getSource() %>
            </td>
            <td><%=p.getAccepted() %>
